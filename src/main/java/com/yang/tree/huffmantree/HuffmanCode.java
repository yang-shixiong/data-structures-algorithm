...
public class HuffmanCode {
    ...
    public static void main(String[] args) {
        ...
        //����ѹ���ļ�
        String srcFile = "E:\\ss.png";
        String dstFile = "E:\\s2.zip";
...
//		���Խ�ѹ�ļ�
        String zipFile = "E:\\s2.zip";
        String dstFile2 = "E:\\s2.png";
...
//		System.out.println("ԭ�����ַ���=" + new String(sourceBytes)); // "i like like like java do you like a java"
    ...
    private static byte[] huffmanZip(byte[] bytes) {
        ...
        //���� nodes �����ĺշ�����
        Nodes huffmanTreeRoot = createHuffmanTree(nodes);
        huffmanTreeRoot.preOrder();
        //��Ӧ�ĺշ�������(���� �շ�����)
        Map<Byte, String> huffmanCodes = getCodes(huffmanTreeRoot);
        //�������ɵĺշ������룬ѹ���õ�ѹ����ĺշ��������ֽ�����
     ...
     */
    private static void getCodes(Nodes node, String code, StringBuilder stringBuilder) {
